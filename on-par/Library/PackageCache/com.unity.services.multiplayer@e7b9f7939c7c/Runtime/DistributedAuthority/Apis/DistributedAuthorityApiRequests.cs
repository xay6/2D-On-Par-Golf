...
using Unity.Services.DistributedAuthority.Scheduler;
...
namespace Unity.Services.DistributedAuthority.DistributedAuthority
{
    ...
    /// <summary>
    /// DistributedAuthorityApiBaseRequest class
    /// </summary>
    [Preserve]
    internal class DistributedAuthorityApiBaseRequest
    {
        /// <summary>
    ...
    /// </summary>
    [Preserve]
    internal class CreateSessionRequest : DistributedAuthorityApiBaseRequest
    {
        /// <summary>Accessor for session </summary>
        [Preserve]
        public Unity.Services.DistributedAuthority.Models.Session Session { get; }
        ...
        /// Create new session
        /// </summary>
        /// <param name="session">Session param</param>
        [Preserve]
        public CreateSessionRequest(Unity.Services.DistributedAuthority.Models.Session session)
        {
            Session = session;
