...
namespace Unity.Ucg.Usqp
{
    ...
    {
        public UsqpHeader Header;
        public ushort Version; // Setting default returns "Feature 'struct field initializers' is not available in C# 9.0. Please use language version 10.0 or greater."
        ...
        public void ToStream(ref DataStreamWriter writer)
        {
            ...
            // Set according to Multiplay reference: https://github.com/Unity-Technologies/docs-ugs-dsb/blob/4e54ae11e17d3087d33dfd29ce8cbcc2c2029fdb/project/en-US/manual/game-server-hosting/includes/sqp.md#request-format-1 
            Version = 1;
            writer.WriteUShortNetworkByteOrder(Version);
