...
namespace Unity.Services.Matchmaker.Matches
{
    ...
    /// <summary>
    /// GetMatchmakingResultsRequest
    /// Returns the MatchmakingResults
    /// </summary>
    [Preserve]
    internal class GetMatchmakingResultsRequest : MatchesApiBaseRequest
    {
        /// <summary>Accessor for matchId </summary>
        [Preserve]
        ...
        /// <summary>
        /// GetMatchmakingResults Request Object.
        /// Returns the MatchmakingResults
        /// </summary>
        /// <param name="matchId">ID of Match, as returned from the tickets API</param>
        /// <param name="projectId">Unity project ID</param>
        [Preserve]
        public GetMatchmakingResultsRequest(string matchId, string projectId)
        {
            MatchId = matchId;

            ProjectId = projectId;

            PathAndQueryParams = $"/v2/projects/{projectId}/matches/{matchId}/matchmaking-results";
