...
namespace Unity.Services.Matchmaker.Models
{
    ...
    public class StoredMatchmakingResults
    {
        ...
        /// <param name="queueName">Matchmaking queue that created the match.</param>
        /// <param name="poolName">Matchmaking pool that created the match.</param>
        ...
        [Preserve]
        public StoredMatchmakingResults(StoredMatchProperties matchProperties = default, string generatorName = default, string queueName = default, string poolName = default, string environmentId = default, string backfillTicketId = default, string matchId = default, string poolId = default)
        {
        ...
        /// <summary>
        /// Formats a StoredMatchmakingResults into a string of key-value pairs for use as a path parameter.
        /// </summary>
        ...
        /// <summary>
        /// Returns a StoredMatchmakingResults as a dictionary of key-value pairs for use as a query parameter.
        /// </summary>
