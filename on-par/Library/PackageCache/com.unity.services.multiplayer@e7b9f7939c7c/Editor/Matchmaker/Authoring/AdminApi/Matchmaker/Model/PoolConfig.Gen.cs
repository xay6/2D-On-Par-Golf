...
namespace Unity.Services.Multiplayer.Editor.Matchmaker.Authoring.AdminApi.Matchmaker.Model
{
    ...
    partial class PoolConfig
    {
        ...
        [Preserve]
        public PoolConfig(string name = default(string), bool enabled = true, MatchHosting matchHosting = default(MatchHosting), int timeoutSeconds = default(int), Rules matchLogic = default(Rules))
        {
            if (name == null)
            {
