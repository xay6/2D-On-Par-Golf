...
namespace Unity.Services.Multiplay.Authoring.Editor.AdminApis.Fleets.Models
{
    ...
    internal class FleetCreateRequest
    {
        ...
        [Preserve]
        public FleetCreateRequest(string name, List<long> buildConfigurations, List<Region> regions, System.Guid osID = default, OsFamilyOptions osFamily = default, AllocationTypeOptions allocationType = default, List<FleetUsageSetting> usageSettings = default, bool graceful = default)
        {
            Name = name;
            OsID = osID;
            OsFamily = osFamily;
