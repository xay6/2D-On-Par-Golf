...
namespace Unity.Services.Multiplay.Authoring.Editor.AdminApis.Builds.Models
{
    ...
    internal class BuildListInner1
    {
        ...
        [Preserve]
        public BuildListInner1(string buildVersionName, string fleetName, long completedMachines, long pendingMachines, List<BuildListInner1FailuresInner> failures, List<RegionsInner> regions, System.Guid ccdBucketID = default, CCDDetails ccd = default, ContainerImage container = default)
        {
