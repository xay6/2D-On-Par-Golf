...
namespace Unity.Services.Multiplay.Authoring.Editor.AdminApis.Fleets.Models
{
    ...
    /// </summary>
    [Preserve]
    [DataContract(Name = "Time_Series_Dataset")]
    internal class TimeSeriesDataset
    {
        /// <summary>
        /// A dataset of Unix time (ms) and int64 values.
        /// </summary>
        ...
        [Preserve]
        public TimeSeriesDataset(string name, List<List<long>> data)
        {
            Name = name;
            Data = data;
        }
        ...
        /// <summary>
        /// Formats a TimeSeriesDataset into a string of key-value pairs for use as a path parameter.
        /// </summary>
        ...
        /// <summary>
        /// Returns a TimeSeriesDataset as a dictionary of key-value pairs for use as a query parameter.
        /// </summary>
