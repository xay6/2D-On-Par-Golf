...
namespace Unity.Services.Multiplay.Authoring.Editor.AdminApis.Ccd.Models
{
    ...
    internal class CcdBucket
    {
        ...
        [Preserve]
        public CcdBucket(GetBucket200ResponseAttributes attributes = default, GetBucket200ResponseChanges changes = default, DateTime created = default, string description = default, System.Guid environmentId = default, string environmentName = default, System.Guid id = default, GetBucket200ResponseLastRelease lastRelease = default, string name = default, GetBucket200ResponsePermissions permissions = default, bool @private = default, System.Guid projectguid = default)
        {
