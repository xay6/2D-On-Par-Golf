...
namespace Unity.Services.Multiplay.Authoring.Editor.AdminApis.Ccd.Users
{
    ...
    internal class RegenerateUserApiKeyRequest : UsersApiBaseRequest
    {
        ...
        [Preserve]
        public string Userid { get; }
        /// <summary>Accessor for getUserApiKey200Response </summary>
        [Preserve]
        public Unity.Services.Multiplay.Authoring.Editor.AdminApis.Ccd.Models.GetUserApiKey200Response GetUserApiKey200Response { get; }
        string PathAndQueryParams;
        ...
        /// </summary>
        /// <param name="userid">User ID</param>
        /// <param name="getUserApiKey200Response">ApiKey</param>
        [Preserve]
        public RegenerateUserApiKeyRequest(string userid, Unity.Services.Multiplay.Authoring.Editor.AdminApis.Ccd.Models.GetUserApiKey200Response getUserApiKey200Response)
        {
            Userid = userid;

            GetUserApiKey200Response = getUserApiKey200Response;
            PathAndQueryParams = $"/api/ccd/management/v1/users/{userid}/apikey";
        ...
        public byte[] ConstructBody()
        {
            return ConstructBody(GetUserApiKey200Response);
        }
