...
namespace Unity.Services.Multiplay.Authoring.Editor.AdminApis.Allocations.Models
{
    ...
    internal class MultiplayAllocationsTestAllocateRequest
    {
        /// <summary>
        /// Multipart-form request to process a test allocation. The form size is capped at 32Mb to prevent overloading.
        /// </summary>
        ...
        [Preserve]
        public MultiplayAllocationsTestAllocateRequest(System.Guid regionId, long buildConfigurationId, System.Guid allocationId, bool restart = default, string payload = default)
        {
            RegionId = regionId;
        ...
        /// <summary>
        /// Formats a MultiplayAllocationsTestAllocateRequest into a string of key-value pairs for use as a path parameter.
        /// </summary>
        ...
        /// <summary>
        /// Returns a MultiplayAllocationsTestAllocateRequest as a dictionary of key-value pairs for use as a query parameter.
        /// </summary>
