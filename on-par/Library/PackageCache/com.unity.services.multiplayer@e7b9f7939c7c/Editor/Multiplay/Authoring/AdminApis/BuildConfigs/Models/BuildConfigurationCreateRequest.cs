...
namespace Unity.Services.Multiplay.Authoring.Editor.AdminApis.BuildConfigs.Models
{
    ...
    /// </summary>
    [Preserve]
    [DataContract(Name = "Build_Configuration_Create_Request")]
    internal class BuildConfigurationCreateRequest
    {
        /// <summary>
        /// Request to create a build configuration with the provided configuration.
        /// </summary>
        ...
        [Preserve]
        public BuildConfigurationCreateRequest(string name, long buildID, string queryType, string binaryPath, string commandLine, bool readiness, List<ConfigurationPair> configuration = default, long cores = default, long speed = default, long memory = default)
        {
            Name = name;
            BuildID = buildID;
        ...
        public List<ConfigurationPair> _Configuration{ get; }
        ...
        /// <summary>
        /// Formats a BuildConfigurationCreateRequest into a string of key-value pairs for use as a path parameter.
        /// </summary>
        ...
        /// <summary>
        /// Returns a BuildConfigurationCreateRequest as a dictionary of key-value pairs for use as a query parameter.
        /// </summary>
