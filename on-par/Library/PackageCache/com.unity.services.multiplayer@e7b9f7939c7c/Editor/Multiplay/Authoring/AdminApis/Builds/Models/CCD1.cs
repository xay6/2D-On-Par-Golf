...
namespace Unity.Services.Multiplay.Authoring.Editor.AdminApis.Builds.Models
{
    ...
    internal class CCD1
    {
        ...
        [Preserve]
        public CCD1(System.Guid bucketID, System.Guid releaseID, string managementAPIKey)
        {
            BucketID = bucketID;
            ReleaseID = releaseID;
        ...
        /// <summary>
        /// Formats a CCD1 into a string of key-value pairs for use as a path parameter.
        /// </summary>
        ...
        /// <summary>
        /// Returns a CCD1 as a dictionary of key-value pairs for use as a query parameter.
        /// </summary>
