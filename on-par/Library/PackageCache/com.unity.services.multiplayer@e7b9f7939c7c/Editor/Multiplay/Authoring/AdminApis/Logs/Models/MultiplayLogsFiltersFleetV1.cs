...
namespace Unity.Services.Multiplay.Authoring.Editor.AdminApis.Logs.Models
{
    ...
    /// </summary>
    [Preserve]
    [DataContract(Name = "multiplay.logsFiltersFleet.v1")]
    internal class MultiplayLogsFiltersFleetV1
    {
        /// <summary>
        /// A single fleet in the project that can be used for filtering.
        /// </summary>
        ...
        [Preserve]
        public MultiplayLogsFiltersFleetV1(System.Guid id, string name, bool deleted, DateTime deletedOn = default)
        {
            Id = id;
            Name = name;
            Deleted = deleted;
        ...
        /// <summary>
        /// Formats a MultiplayLogsFiltersFleetV1 into a string of key-value pairs for use as a path parameter.
        /// </summary>
        ...
        /// <summary>
        /// Returns a MultiplayLogsFiltersFleetV1 as a dictionary of key-value pairs for use as a query parameter.
        /// </summary>
