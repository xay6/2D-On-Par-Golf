...
namespace Unity.Services.Multiplay.Authoring.Editor.AdminApis.Servers.Models
{
    ...
    internal class MultiplayServersActionLog
    {
        /// <summary>
        /// A server action log.
        /// </summary>
        ...
        [Preserve]
        public MultiplayServersActionLog(long id, long serverID, long actionID, long machineID, string message, DateTime date, string attachment = default)
        {
            Id = id;
            ServerID = serverID;
            ActionID = actionID;
        ...
        /// <summary>
        /// Formats a MultiplayServersActionLog into a string of key-value pairs for use as a path parameter.
        /// </summary>
        ...
        /// <summary>
        /// Returns a MultiplayServersActionLog as a dictionary of key-value pairs for use as a query parameter.
        /// </summary>
