...
namespace Unity.Services.Multiplay.Authoring.Editor.AdminApis.Fleets.Models
{
    ...
    /// </summary>
    [Preserve]
    [DataContract(Name = "Update_Region_Request")]
    internal class UpdateRegionRequest
    {
        /// <summary>
        /// Request to update the settings of a fleet region with the provided configuration.
        /// </summary>
        ...
        [Preserve]
        public UpdateRegionRequest(bool scalingEnabled, long minAvailableServers, long maxServers, long deleteTTL = default, long shutdownTTL = default, long disabledDeleteTTL = default)
        {
        ...
        /// <summary>
        /// Formats a UpdateRegionRequest into a string of key-value pairs for use as a path parameter.
        /// </summary>
        ...
        /// <summary>
        /// Returns a UpdateRegionRequest as a dictionary of key-value pairs for use as a query parameter.
        /// </summary>
