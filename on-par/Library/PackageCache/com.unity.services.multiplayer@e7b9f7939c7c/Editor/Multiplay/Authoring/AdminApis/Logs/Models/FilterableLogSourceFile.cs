...
namespace Unity.Services.Multiplay.Authoring.Editor.AdminApis.Logs.Models
{
    ...
    /// </summary>
    [Preserve]
    [DataContract(Name = "Filterable_log_source_file")]
    internal class FilterableLogSourceFile
    {
        /// <summary>
        /// A single log source file that can be used for filtering.
        /// </summary>
        ...
        [Preserve]
        public FilterableLogSourceFile(string source, string name)
        {
            Source = source;
            Name = name;
        }
        ...
        /// <summary>
        /// Formats a FilterableLogSourceFile into a string of key-value pairs for use as a path parameter.
        /// </summary>
        ...
        /// <summary>
        /// Returns a FilterableLogSourceFile as a dictionary of key-value pairs for use as a query parameter.
        /// </summary>
