...
namespace Unity.Services.Multiplay.Authoring.Editor.AdminApis.Fleets.Models
{
    ...
    internal class MultiplayFleetUpdateRequest
    {
        ...
        [Preserve]
        public MultiplayFleetUpdateRequest(string name, System.Guid osID, List<long> buildConfigurations, long deleteTTL = default, long shutdownTTL = default, long disabledDeleteTTL = default, long allocationTTL = default, bool graceful = default, List<FleetUsageSetting> usageSettings = default)
        {
            Name = name;
            OsID = osID;
