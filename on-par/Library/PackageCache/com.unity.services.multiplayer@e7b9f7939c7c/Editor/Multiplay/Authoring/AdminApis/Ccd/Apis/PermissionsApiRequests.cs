...
namespace Unity.Services.Multiplay.Authoring.Editor.AdminApis.Ccd.Permissions
{
    ...
    internal class CreatePermissionByBucketRequest : PermissionsApiBaseRequest
    {
        ...
        /// <summary>Accessor for updatePermissionByBucketRequest </summary>
        [Preserve]
        public Unity.Services.Multiplay.Authoring.Editor.AdminApis.Ccd.Models.UpdatePermissionByBucketRequest UpdatePermissionByBucketRequest { get; }
        ...
        /// <param name="updatePermissionByBucketRequest">Permission</param>
        [Preserve]
        public CreatePermissionByBucketRequest(string bucketid, string projectid, Unity.Services.Multiplay.Authoring.Editor.AdminApis.Ccd.Models.UpdatePermissionByBucketRequest updatePermissionByBucketRequest)
        {
            Bucketid = bucketid;

            Projectid = projectid;

            UpdatePermissionByBucketRequest = updatePermissionByBucketRequest;
        ...
        {
            return ConstructBody(UpdatePermissionByBucketRequest);
        }
    ...
    internal class CreatePermissionByBucketEnvRequest : PermissionsApiBaseRequest
    {
        ...
        /// <param name="updatePermissionByBucketRequest">Permission</param>
        [Preserve]
        public CreatePermissionByBucketEnvRequest(string environmentid, string bucketid, string projectid, Unity.Services.Multiplay.Authoring.Editor.AdminApis.Ccd.Models.UpdatePermissionByBucketRequest updatePermissionByBucketRequest)
        {
    ...
    internal class UpdatePermissionByBucketRequest : PermissionsApiBaseRequest
    {
        ...
        [Preserve]
        public string Projectid { get; }
        /// <summary>Accessor for updatePermissionByBucketRequestParameter </summary>
        [Preserve]
        public Unity.Services.Multiplay.Authoring.Editor.AdminApis.Ccd.Models.UpdatePermissionByBucketRequest UpdatePermissionByBucketRequestParameter { get; }
        string PathAndQueryParams;
        ...
        /// <param name="bucketid">Bucket ID</param>
        /// <param name="projectid">Project ID</param>
        /// <param name="updatePermissionByBucketRequestParameter">Permission</param>
        [Preserve]
        public UpdatePermissionByBucketRequest(string bucketid, string projectid, Unity.Services.Multiplay.Authoring.Editor.AdminApis.Ccd.Models.UpdatePermissionByBucketRequest updatePermissionByBucketRequestParameter)
        {
            Bucketid = bucketid;

            Projectid = projectid;

            UpdatePermissionByBucketRequestParameter = updatePermissionByBucketRequestParameter;
            PathAndQueryParams = $"/api/ccd/management/v1/projects/{projectid}/buckets/{bucketid}/permissions";
        ...
        public byte[] ConstructBody()
        {
            return ConstructBody(UpdatePermissionByBucketRequestParameter);
        }
    ...
    internal class UpdatePermissionByBucketEnvRequest : PermissionsApiBaseRequest
    {
        ...
        /// <param name="updatePermissionByBucketRequest">Permission</param>
        [Preserve]
        public UpdatePermissionByBucketEnvRequest(string environmentid, string bucketid, string projectid, Unity.Services.Multiplay.Authoring.Editor.AdminApis.Ccd.Models.UpdatePermissionByBucketRequest updatePermissionByBucketRequest)
        {
            Environmentid = environmentid;
