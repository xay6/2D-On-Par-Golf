...
namespace Unity.Services.Multiplay.Authoring.Editor.AdminApis.Logs.Models
{
    ...
    /// </summary>
    [Preserve]
    [DataContract(Name = "multiplay.logsUsageResponse.v1")]
    internal class MultiplayLogsUsageResponseV1
    {
        /// <summary>
        /// Usage information for the project.
        /// </summary>
        ...
        [Preserve]
        public MultiplayLogsUsageResponseV1(double usage, double capacity, double remaining)
        {
            Usage = usage;
            Capacity = capacity;
            Remaining = remaining;
        ...
        /// <summary>
        /// Formats a MultiplayLogsUsageResponseV1 into a string of key-value pairs for use as a path parameter.
        /// </summary>
        ...
        /// <summary>
        /// Returns a MultiplayLogsUsageResponseV1 as a dictionary of key-value pairs for use as a query parameter.
        /// </summary>
