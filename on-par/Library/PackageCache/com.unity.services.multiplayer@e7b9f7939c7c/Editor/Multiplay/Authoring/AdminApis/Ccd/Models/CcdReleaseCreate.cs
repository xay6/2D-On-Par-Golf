...
namespace Unity.Services.Multiplay.Authoring.Editor.AdminApis.Ccd.Models
{
    ...
    internal class CcdReleaseCreate
    {
        /// <summary>
        ...
        [Preserve]
        public CcdReleaseCreate(List<CreateReleaseRequestEntriesInner> entries = default, object metadata = default, string notes = default, DateTime snapshot = default)
        {
            Entries = entries;
