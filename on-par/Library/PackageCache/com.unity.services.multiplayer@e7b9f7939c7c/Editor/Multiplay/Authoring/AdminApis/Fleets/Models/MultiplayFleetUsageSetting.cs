...
namespace Unity.Services.Multiplay.Authoring.Editor.AdminApis.Fleets.Models
{
    ...
    internal class MultiplayFleetUsageSetting
    {
        /// <summary>
        /// A usage setting associated with the fleet.
        /// </summary>
        ...
        [Preserve]
        public MultiplayFleetUsageSetting(HardwareTypeOptions hardwareType, long fleetUsageID = default, string machineType = default, long speed = default, long memory = default, long maxServersPerMachine = default, long maxServersPerCore = default)
        {
        ...
        /// <summary>
        /// Formats a MultiplayFleetUsageSetting into a string of key-value pairs for use as a path parameter.
        /// </summary>
        ...
        /// <summary>
        /// Returns a MultiplayFleetUsageSetting as a dictionary of key-value pairs for use as a query parameter.
        /// </summary>
