...
namespace Unity.Services.Multiplay.Authoring.Editor.AdminApis.Fleets.Models
{
    ...
    /// </summary>
    [Preserve]
    [DataContract(Name = "Fleet_Build_Configuration_Switch_Status")]
    internal class FleetBuildConfigurationSwitchStatus
    {
        /// <summary>
        /// The status of the active build configuration switch for a reservations-based fleet.
        /// </summary>
        ...
        [Preserve]
        public FleetBuildConfigurationSwitchStatus(long buildConfigurationId, long serversProcessed, long serversPending, StateOptions state, DateTime deadline, long oldBuildConfigurationId = default)
        {
        ...
        /// <summary>
        /// Formats a FleetBuildConfigurationSwitchStatus into a string of key-value pairs for use as a path parameter.
        /// </summary>
        ...
        /// <summary>
        /// Returns a FleetBuildConfigurationSwitchStatus as a dictionary of key-value pairs for use as a query parameter.
        /// </summary>
