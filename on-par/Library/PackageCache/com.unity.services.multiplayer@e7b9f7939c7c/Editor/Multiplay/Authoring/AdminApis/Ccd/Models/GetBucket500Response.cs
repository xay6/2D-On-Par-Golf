...
{
    /// <summary>
    /// GetBucket500Response model
    /// </summary>
    [Preserve]
    [DataContract(Name = "GetBucket_500_response")]
    internal class GetBucket500Response
    {
        /// <summary>
        /// Creates an instance of GetBucket500Response.
        /// </summary>
        /// <param name="title">title param</param>
        /// <param name="status">status param</param>
        /// <param name="requestId">requestId param</param>
        [Preserve]
        public GetBucket500Response(string title = default, int status = default, string requestId = default)
        {
            Title = title;
            Status = status;
            RequestId = requestId;
        ...
        /// <summary>
        /// Parameter title of GetBucket500Response
        /// </summary>
        [Preserve]
        ...
        /// <summary>
        /// Parameter status of GetBucket500Response
        /// </summary>
        [Preserve]
        ...
        /// <summary>
        /// Parameter requestId of GetBucket500Response
        /// </summary>
        [Preserve]
        ...
        /// <summary>
        /// Formats a GetBucket500Response into a string of key-value pairs for use as a path parameter.
        /// </summary>
        ...
        /// <summary>
        /// Returns a GetBucket500Response as a dictionary of key-value pairs for use as a query parameter.
        /// </summary>
