...
namespace Unity.Services.Multiplay.Authoring.Editor.AdminApis.Logs.Models
{
    ...
    /// </summary>
    [Preserve]
    [DataContract(Name = "Log_Status_Response")]
    internal class LogStatusResponse
    {
        /// <summary>
        /// Response for log status requests indicating whether or not logging is enabled
        /// </summary>
        ...
        [Preserve]
        public LogStatusResponse(StatusOptions status)
        {
            Status = status;
        }
        ...
        /// <summary>
        /// Formats a LogStatusResponse into a string of key-value pairs for use as a path parameter.
        /// </summary>
        ...
        /// <summary>
        /// Returns a LogStatusResponse as a dictionary of key-value pairs for use as a query parameter.
        /// </summary>
