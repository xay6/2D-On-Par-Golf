...
namespace Unity.Services.Multiplay.Authoring.Editor.AdminApis.Fleets.Models
{
    ...
    /// </summary>
    [Preserve]
    [DataContract(Name = "Updated_Fleet_Region")]
    internal class UpdatedFleetRegion
    {
        /// <summary>
        /// Updated fleet region
        /// </summary>
        ...
        [Preserve]
        public UpdatedFleetRegion(System.Guid id, System.Guid regionID, string regionName, bool scalingEnabled, long minAvailableServers, long maxServers, long deleteTTL = default, long shutdownTTL = default, long disabledDeleteTTL = default)
        {
            Id = id;
            RegionID = regionID;
        ...
        /// <summary>
        /// Formats a UpdatedFleetRegion into a string of key-value pairs for use as a path parameter.
        /// </summary>
        ...
        /// <summary>
        /// Returns a UpdatedFleetRegion as a dictionary of key-value pairs for use as a query parameter.
        /// </summary>
