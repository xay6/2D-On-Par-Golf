...
namespace Unity.Services.Multiplay.Authoring.Editor.AdminApis.Logs.Models
{
    ...
    /// </summary>
    [Preserve]
    [DataContract(Name = "multiplay.logSearchRequest.v1")]
    internal class MultiplayLogSearchRequestV1
    {
        /// <summary>
        /// Filtering and pagination for searching game server logs
        /// </summary>
        ...
        [Preserve]
        public MultiplayLogSearchRequestV1(string query, int size, LogSearchRequestFilters filters, string paginationToken)
        {
            Query = query;
            Size = size;
            Filters = filters;
        ...
        /// <summary>
        /// Parameter filters of MultiplayLogSearchRequestV1
        /// </summary>
        [Preserve]
        ...
        /// <summary>
        /// Formats a MultiplayLogSearchRequestV1 into a string of key-value pairs for use as a path parameter.
        /// </summary>
        ...
        /// <summary>
        /// Returns a MultiplayLogSearchRequestV1 as a dictionary of key-value pairs for use as a query parameter.
        /// </summary>
