...
namespace Unity.Services.Multiplay.Authoring.Editor.AdminApis.Servers.Models
{
    ...
    /// </summary>
    [Preserve]
    [DataContract(Name = "Action_Request")]
    internal class ActionRequest
    {
        ...
        [Preserve]
        public ActionRequest(ActionOptions action)
        {
            Action = action;
        }
        ...
        /// <summary>
        /// Formats a ActionRequest into a string of key-value pairs for use as a path parameter.
        /// </summary>
        ...
        /// <summary>
        /// Returns a ActionRequest as a dictionary of key-value pairs for use as a query parameter.
        /// </summary>
