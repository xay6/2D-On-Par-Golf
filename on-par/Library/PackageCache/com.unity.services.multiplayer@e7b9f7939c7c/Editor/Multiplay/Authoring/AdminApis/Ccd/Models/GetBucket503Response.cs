...
{
    /// <summary>
    /// GetBucket503Response model
    /// </summary>
    [Preserve]
    [DataContract(Name = "GetBucket_503_response")]
    internal class GetBucket503Response
    {
        /// <summary>
        /// Creates an instance of GetBucket503Response.
        /// </summary>
        /// <param name="title">title param</param>
        /// <param name="status">status param</param>
        /// <param name="requestId">requestId param</param>
        [Preserve]
        public GetBucket503Response(string title = default, int status = default, string requestId = default)
        {
            Title = title;
            Status = status;
            RequestId = requestId;
        ...
        /// <summary>
        /// Parameter title of GetBucket503Response
        /// </summary>
        [Preserve]
        ...
        /// <summary>
        /// Parameter status of GetBucket503Response
        /// </summary>
        [Preserve]
        ...
        /// <summary>
        /// Parameter requestId of GetBucket503Response
        /// </summary>
        [Preserve]
        ...
        /// <summary>
        /// Formats a GetBucket503Response into a string of key-value pairs for use as a path parameter.
        /// </summary>
        ...
        /// <summary>
        /// Returns a GetBucket503Response as a dictionary of key-value pairs for use as a query parameter.
        /// </summary>
