...
namespace Unity.Services.Multiplay.Authoring.Editor.AdminApis.BuildConfigs.Models
{
    ...
    internal class BuildConfigurationUpdateRequest
    {
        ...
        [Preserve]
        public BuildConfigurationUpdateRequest(string name, long buildID, List<ConfigurationPair1> configuration, string queryType, string binaryPath, string commandLine, bool readiness, long cores = default, long speed = default, long memory = default)
        {
            Name = name;
            BuildID = buildID;
