...
namespace Unity.Services.Multiplay.Authoring.Editor.AdminApis.Fleets.Models
{
    ...
    internal class MultiplayFleetCreateRequestRegion
    {
        /// <summary>
        /// A region association to create.
        /// </summary>
        /// <param name="regionID">ID of the region to associate with the fleet.</param>
        ...
        [Preserve]
        public MultiplayFleetCreateRequestRegion(System.Guid regionID, long minAvailableServers, long maxServers)
        {
            RegionID = regionID;
        ...
        /// <summary>
        /// Formats a MultiplayFleetCreateRequestRegion into a string of key-value pairs for use as a path parameter.
        /// </summary>
        ...
        /// <summary>
        /// Returns a MultiplayFleetCreateRequestRegion as a dictionary of key-value pairs for use as a query parameter.
        /// </summary>
