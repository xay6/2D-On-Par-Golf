...
namespace Unity.Services.Multiplay.Authoring.Editor.AdminApis.Servers.Models
{
    ...
    /// </summary>
    [Preserve]
    [DataContract(Name = "Time_series__int64_")]
    internal class TimeSeriesInt64
    {
        /// <summary>
        /// Time series int64 metrics for the given server.
        /// </summary>
        ...
        [Preserve]
        public TimeSeriesInt64(string name, List<List<long>> data)
        {
            Name = name;
            Data = data;
        }
        ...
        /// <summary>
        /// Formats a TimeSeriesInt64 into a string of key-value pairs for use as a path parameter.
        /// </summary>
        ...
        /// <summary>
        /// Returns a TimeSeriesInt64 as a dictionary of key-value pairs for use as a query parameter.
        /// </summary>
