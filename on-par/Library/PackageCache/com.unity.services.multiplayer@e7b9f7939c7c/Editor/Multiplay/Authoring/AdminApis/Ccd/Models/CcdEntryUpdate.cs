...
namespace Unity.Services.Multiplay.Authoring.Editor.AdminApis.Ccd.Models
{
    ...
    internal class CcdEntryUpdate
    {
        ...
        [Preserve]
        public CcdEntryUpdate(string contentHash = default, long contentSize = default, string contentType = default, List<string> labels = default, object metadata = default, bool signedUrl = default)
        {
