...
namespace Unity.Services.Multiplay.Authoring.Editor.AdminApis.Fleets.Models
{
    ...
    /// </summary>
    [Preserve]
    [DataContract(Name = "Add_Region_Request")]
    internal class AddRegionRequest
    {
        /// <summary>
        /// Request to add a region to a fleet with the provided configuration.
        /// </summary>
        ...
        [Preserve]
        public AddRegionRequest(System.Guid regionID, long minAvailableServers, long maxServers)
        {
            RegionID = regionID;
        ...
        /// <summary>
        /// Formats a AddRegionRequest into a string of key-value pairs for use as a path parameter.
        /// </summary>
        ...
        /// <summary>
        /// Returns a AddRegionRequest as a dictionary of key-value pairs for use as a query parameter.
        /// </summary>
