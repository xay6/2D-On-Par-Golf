...
namespace Unity.Services.Multiplay.Authoring.Editor.AdminApis.Fleets.Models
{
    ...
    /// </summary>
    [Preserve]
    [DataContract(Name = "Fleet_Region_1")]
    internal class FleetRegion1
    {
        /// <summary>
        /// An association between the fleet and a region.
        /// </summary>
        ...
        [Preserve]
        public FleetRegion1(System.Guid id, System.Guid regionID, string regionName, bool scalingEnabled, StatusOptions status, long minAvailableServers, long maxServers, long deleteTTL = default, long shutdownTTL = default, long disabledDeleteTTL = default)
        {
            Id = id;
            RegionID = regionID;
        ...
        /// <summary>
        /// Formats a FleetRegion1 into a string of key-value pairs for use as a path parameter.
        /// </summary>
        ...
        /// <summary>
        /// Returns a FleetRegion1 as a dictionary of key-value pairs for use as a query parameter.
        /// </summary>
