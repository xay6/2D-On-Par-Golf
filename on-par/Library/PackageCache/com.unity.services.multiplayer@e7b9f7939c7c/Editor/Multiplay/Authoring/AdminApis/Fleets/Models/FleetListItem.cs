...
namespace Unity.Services.Multiplay.Authoring.Editor.AdminApis.Fleets.Models
{
    ...
    internal class FleetListItem
    {
        ...
        [Preserve]
        public FleetListItem(System.Guid id, string name, System.Guid osID, string osName, List<BuildConfiguration> buildConfigurations, List<FleetRegion> regions, Servers servers, StatusOptions status, AllocationTypeOptions allocationType, List<FleetUsageSetting> usageSettings = default, bool graceful = default)
        {
            Id = id;
            Name = name;
            OsID = osID;
        ...
        /// <summary>
        /// Parameter servers of FleetListItem
        /// </summary>
        [Preserve]
