...
namespace Unity.Services.Multiplay.Authoring.Editor.AdminApis.Logs.Models
{
    ...
    /// </summary>
    [Preserve]
    [DataContract(Name = "multiplay.logSearchRequestFilters.v1")]
    internal class MultiplayLogSearchRequestFiltersV1
    {
        /// <summary>
        /// Filters for a search request.
        /// </summary>
        ...
        [Preserve]
        public MultiplayLogSearchRequestFiltersV1(System.Guid fleetId, string serverId, string source, DateTime from = default, DateTime to = default)
        {
            FleetId = fleetId;
            ServerId = serverId;
            Source = source;
        ...
        /// <summary>
        /// Formats a MultiplayLogSearchRequestFiltersV1 into a string of key-value pairs for use as a path parameter.
        /// </summary>
        ...
        /// <summary>
        /// Returns a MultiplayLogSearchRequestFiltersV1 as a dictionary of key-value pairs for use as a query parameter.
        /// </summary>
