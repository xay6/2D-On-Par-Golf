...
namespace Unity.Services.Multiplay.Authoring.Editor.AdminApis.BuildConfigs.Models
{
    ...
    internal class MultiplayBuildConfigurationListItem
    {
        /// <summary>
        /// A build configuration for configuring game builds to run on servers.
        /// </summary>
        ...
        [Preserve]
        public MultiplayBuildConfigurationListItem(long id, string name, long buildID, string buildName, long version, System.Guid fleetID = default, string fleetName = default, DateTime updatedAt = default, DateTime createdAt = default)
        {
            Id = id;
            Name = name;
            BuildID = buildID;
        ...
        /// <summary>
        /// Formats a MultiplayBuildConfigurationListItem into a string of key-value pairs for use as a path parameter.
        /// </summary>
        ...
        /// <summary>
        /// Returns a MultiplayBuildConfigurationListItem as a dictionary of key-value pairs for use as a query parameter.
        /// </summary>
