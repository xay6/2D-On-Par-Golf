...
namespace Unity.Services.Multiplay.Authoring.Editor.AdminApis.Fleets.Models
{
    ...
    /// </summary>
    [Preserve]
    [DataContract(Name = "New_Fleet_Region")]
    internal class NewFleetRegion
    {
        /// <summary>
        /// Newly added fleet region
        /// </summary>
        ...
        [Preserve]
        public NewFleetRegion(System.Guid id, System.Guid regionID, string regionName, long minAvailableServers, long maxServers)
        {
            Id = id;
            RegionID = regionID;
        ...
        /// <summary>
        /// Formats a NewFleetRegion into a string of key-value pairs for use as a path parameter.
        /// </summary>
        ...
        /// <summary>
        /// Returns a NewFleetRegion as a dictionary of key-value pairs for use as a query parameter.
        /// </summary>
