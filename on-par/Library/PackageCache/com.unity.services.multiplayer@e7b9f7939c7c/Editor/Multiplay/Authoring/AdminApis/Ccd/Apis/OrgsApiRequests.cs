...
namespace Unity.Services.Multiplay.Authoring.Editor.AdminApis.Ccd.Orgs
{
    ...
    internal class SaveTosAcceptedRequest : OrgsApiBaseRequest
    {
        ...
        [Preserve]
        public string Orgid { get; }
        /// <summary>Accessor for saveTosAcceptedRequestParameter </summary>
        [Preserve]
        public Unity.Services.Multiplay.Authoring.Editor.AdminApis.Ccd.Models.SaveTosAcceptedRequest SaveTosAcceptedRequestParameter { get; }
        string PathAndQueryParams;
        ...
        /// </summary>
        /// <param name="orgid">Organization ID</param>
        /// <param name="saveTosAcceptedRequestParameter">Org</param>
        [Preserve]
        public SaveTosAcceptedRequest(string orgid, Unity.Services.Multiplay.Authoring.Editor.AdminApis.Ccd.Models.SaveTosAcceptedRequest saveTosAcceptedRequestParameter)
        {
            Orgid = orgid;

            SaveTosAcceptedRequestParameter = saveTosAcceptedRequestParameter;
            PathAndQueryParams = $"/api/ccd/management/v1/organizations/{orgid}";
        ...
        public byte[] ConstructBody()
        {
            return ConstructBody(SaveTosAcceptedRequestParameter);
        }
