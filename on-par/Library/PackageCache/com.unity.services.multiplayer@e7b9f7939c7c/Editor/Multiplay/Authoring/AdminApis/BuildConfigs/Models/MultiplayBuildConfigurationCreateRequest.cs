...
namespace Unity.Services.Multiplay.Authoring.Editor.AdminApis.BuildConfigs.Models
{
    ...
    internal class MultiplayBuildConfigurationCreateRequest
    {
        /// <summary>
        /// Request to create a build configuration with the provided configuration.
        /// </summary>
        ...
        [Preserve]
        public MultiplayBuildConfigurationCreateRequest(string name, long buildID, string queryType, string binaryPath, string commandLine, bool readiness, List<ConfigurationPair> configuration = default, long cores = default, long speed = default, long memory = default)
        {
            Name = name;
            BuildID = buildID;
        ...
        /// <summary>
        /// Formats a MultiplayBuildConfigurationCreateRequest into a string of key-value pairs for use as a path parameter.
        /// </summary>
        ...
        /// <summary>
        /// Returns a MultiplayBuildConfigurationCreateRequest as a dictionary of key-value pairs for use as a query parameter.
        /// </summary>
