...
namespace Unity.Services.Multiplay.Authoring.Editor.AdminApis.Builds.Models
{
    ...
    /// </summary>
    [Preserve]
    [DataContract(Name = "CreateOrUpdateBuildFile_request")]
    internal class CreateOrUpdateBuildFileRequest
    {
        /// <summary>
        /// Request to create or update a build file.
        /// </summary>
        ...
        [Preserve]
        public CreateOrUpdateBuildFileRequest(string path)
        {
            Path = path;
        }
        ...
        /// <summary>
        /// Formats a CreateOrUpdateBuildFileRequest into a string of key-value pairs for use as a path parameter.
        /// </summary>
        ...
        /// <summary>
        /// Returns a CreateOrUpdateBuildFileRequest as a dictionary of key-value pairs for use as a query parameter.
        /// </summary>
