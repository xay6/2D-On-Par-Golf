...
namespace Unity.Services.Multiplay.Authoring.Editor.AdminApis.Fleets.Models
{
    ...
    /// </summary>
    [Preserve]
    [DataContract(Name = "multiplay.fleetInventoryItem")]
    internal class MultiplayFleetInventoryItem
    {
        /// <summary>
        /// Single Inventory item for a fleet.
        /// </summary>
        ...
        [Preserve]
        public MultiplayFleetInventoryItem(HardwareTypeOptions hardwareType, string machineType, string machineFamily, string machineSpecification, long memory, long speed, long numberOfCpus, long machineCount)
        {
        ...
        /// <summary>
        /// Formats a MultiplayFleetInventoryItem into a string of key-value pairs for use as a path parameter.
        /// </summary>
        ...
        /// <summary>
        /// Returns a MultiplayFleetInventoryItem as a dictionary of key-value pairs for use as a query parameter.
        /// </summary>
