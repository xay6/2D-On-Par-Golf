...
namespace Unity.Services.Multiplay.Authoring.Editor.AdminApis.Builds.Models
{
    ...
    /// </summary>
    [Preserve]
    [DataContract(Name = "Build_List_inner_1_failures_inner")]
    internal class BuildListInner1FailuresInner
    {
        /// <summary>
        /// A single build install failure
        /// </summary>
        ...
        [Preserve]
        public BuildListInner1FailuresInner(DateTime updated, long machineID, string reason)
        {
            Updated = updated;
            MachineID = machineID;
            Reason = reason;
        ...
        /// <summary>
        /// Formats a BuildListInner1FailuresInner into a string of key-value pairs for use as a path parameter.
        /// </summary>
        ...
        /// <summary>
        /// Returns a BuildListInner1FailuresInner as a dictionary of key-value pairs for use as a query parameter.
        /// </summary>
