...
namespace Unity.Services.Multiplay.Authoring.Editor.AdminApis.Builds.Models
{
    ...
    internal class MultiplayBuildsS3CreateUpdate
    {
        /// <summary>
        /// Amazon S3 bucket upload based build create or update request.
        /// </summary>
        ...
        [Preserve]
        public MultiplayBuildsS3CreateUpdate(string s3URI, string accessKey, string secretKey)
        {
            S3URI = s3URI;
            AccessKey = accessKey;
            SecretKey = secretKey;
        ...
        /// <summary>
        /// Formats a MultiplayBuildsS3CreateUpdate into a string of key-value pairs for use as a path parameter.
        /// </summary>
        ...
        /// <summary>
        /// Returns a MultiplayBuildsS3CreateUpdate as a dictionary of key-value pairs for use as a query parameter.
        /// </summary>
