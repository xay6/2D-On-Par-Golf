...
namespace Unity.Services.Multiplayer.Editor.Shared.Logging
{
    static class Logger
    {
        const string k_Tag = "[MultiplayAuthoring]";

        const string k_VerboseLoggingDefine = "ENABLE_UNITY_MULTIPLAY_AUTHORING_VERBOSE_LOGGING";
