...
using System.Linq;
using Unity.Services.Multiplayer.Editor.Shared.Infrastructure.Collections;
using UnityEditor;
...
namespace Unity.Services.Multiplayer.Editor.Shared.Assets
{
    class ObservableAssets<T> : ObservableCollection<T>, IDisposable where T : UnityEngine.Object, IPath
    {
        ...
        internal ObservableAssets(AssetPostprocessorProxy assetPostprocessor, bool loadAssets)
        {
