...
namespace Unity.Services.Deployment.Editor.Shared.Logging
{
    static class Logger
    {
        const string k_Tag = "[Deployment]";

        const string k_VerboseLoggingDefine = "ENABLE_UNITY_DEPLOYMENT_VERBOSE_LOGGING";
